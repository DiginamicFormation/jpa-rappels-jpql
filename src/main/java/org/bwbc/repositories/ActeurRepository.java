...
public interface ActeurRepository extends CrudRepository<Acteur, Long> {
	 ...
	 * @return List
	 */
	@Query("From Acteur a WHERE year(a.anniversaire)=:annee")
	 ...
	 * @return List
	 */
	@Query("SELECT distinct a From Acteur a JOIN a.roles r JOIN r.film f JOIN f.realisateurs real WHERE real.identite=:identite and f.annee between :anneeMin and :anneeMax")
